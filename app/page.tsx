    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              className="max-w-xl"
            >
              <h1 className="text-4xl font-normal poppins-font text-gray-900 sm:text-5xl lg:text-6xl mb-6">
      ...
      <section id="features" className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="mt-2 text-3xl poppins-font font-normal text-gray-900 tracking-tight sm:text-4xl">
      ...
      <section className="bg-purple-600">
        <div className="max-w-7xl mx-auto py-12 px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          ...
          >
            <h2 className="text-3xl poppins-font font-normal tracking-tight text-white sm:text-4xl" id="newsletter-headline">
